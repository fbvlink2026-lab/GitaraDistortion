...
class TonePedal {
    ...
    fun makeView(ctx: Context): LinearLayout {
        ...
        card.setBackgroundColor(0xFF103030.toInt())
        card.minimumWidth = 180

        val title = TextView(ctx)
        title.text = "🎨 TONE"
        title.setTextColor(0xFF44DDAA.toInt())
        title.textSize = 14f
        ...
        btn.setOnClickListener {
            ...
            btn.setBackgroundColor(if (isEnabled) 0xFF22AA88.toInt() else 0xFF444444.toInt())
        ...
        levelKnob.baseColor = 0xFF44DDAA.toInt()
        levelKnob.value = level
        val levelPct = TextView(ctx)
        levelPct.text = "50%"
        levelPct.setTextColor(0xFF88DDCC.toInt())
        ...
        lbl.text = "COLOR"
        lbl.setTextColor(0xFF88DDCC.toInt())
        lbl.textSize = 9f
        knobCol.addView(lbl)
