...
class GainPedal {
    ...
    var onAmountChanged: ((Float) -> Unit)? = null
    ...
    fun makeView(ctx: Context): LinearLayout {
        ...
        card.setBackgroundColor(0xFF2A2000.toInt())
        card.minimumWidth = 170

        val title = TextView(ctx)
        title.text = "⚡ GAIN"
        title.setTextColor(0xFFFFDD22.toInt())
        title.textSize = 13f
        ...
        btn.setOnClickListener {
            ...
            btn.setBackgroundColor(if (isEnabled) 0xFFCCAA00.toInt() else 0xFF444444.toInt())
        ...
        val k1 = makeKnob(ctx, "AMOUNT", amount, 0xFFFFDD22.toInt()) {
            amount = it
